      ...
      <div class="card mb-4">
        ...
        <div class="card-body px-4 pt-0 pb-2">
            <form method="post" action="/dashboard/categories" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="name" class="form-label fs-6">Category</label>
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" aria-describedby="emailHelp" required autofocus value="{{ old('name') }}">
                    @error('name')
